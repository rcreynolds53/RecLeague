        ...
        static MockPostRepository()
        {
            ...
            List<Category> cat4 = new List<Category>()
           {
            ...
            _posts = new List<BlogPost>()
            {
                ...
                new BlogPost {BlogPostId = 2, Title = "Soccer Sign-Up", Categories = cat2, Content = "Sign up now for our Co-ed Soccer League! Please contact Judy Thao for more information...", DateCreated = DateTime.Parse("08/01/2017"), Tags = tag2, Status = _statuses[1], UserName = "manager@recleague.com"},
