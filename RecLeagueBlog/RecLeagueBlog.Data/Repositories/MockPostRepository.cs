    ...
    public class MockPostRepository : IBlogPostRepository
    {
        ...
        static MockPostRepository()
        {
            ...
            List<Category> cat4 = new List<Category>()
           {
            ...
            {
                new BlogPost {BlogPostId = 1, Title = "Football Champs", Categories = cat1, Content ="The football championship was helld this weekend...", DateCreated = DateTime.Parse("07/15/2017"), Tags = tag1, StatusId = 2},
                new BlogPost {BlogPostId = 1, Title = "Soccer Sign-Up", Categories = cat2, Content = "Sign up now for our Co-ed Soccer League! Please contact Judy Thao for more information...", DateCreated = DateTime.Parse("08/01/2017"), Tags = tag2, StatusId = 1},
                new BlogPost {BlogPostId = 1, Title = "Curling Cancelled", Categories = cat3, Content ="It is with sadness that we announce that the men's curling league has been cancelled due to a lack of interest in the dying sport.", DateCreated = DateTime.Parse("11/11/2016"), Tags = tag3, StatusId = 1},
